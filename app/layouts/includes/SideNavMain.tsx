...
export default function SideNavMain() {
  ...
  return (
    ...
    <div 
        id="SideNavMain"
        className={`
                fixed z-20bg-white pt-[70px] h-full lg:border-r-0 border-r w-[75px] overflow-auto
    ...
    >
            <div className="lg:w-full w-[55px] mx-auto">
                ...
                <div className="lg:block hidden text-[11px] text-gray-500">
                    <p className="pt-4 px-2">About Newsroom TikTok Show Contact Careers ByteDance</p>
                    <p className="pt-4 px-2">TikTok for Good Advertise developers Transparency TikTok Rewards Browse TokTok Embeds</p>
